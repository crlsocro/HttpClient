...
class HttpServerTest {
    ...
    void shouldPostNewProduct() throws IOException {
        ...
        HttpClient client = new HttpClient("localhost", 10008, "/members", "POST", "name=Axel&email=apple@hotmail.no");
        assertEquals(200, client.getStatusCode());
        assertEquals(List.of("Axel"), server.getprojectNames());
        assertEquals(List.of("apple@hotmail.no"), server.getprojectEmail());
    }
